  ...
  <body>
   ...
   <div class="container" align="center">
        <div class="card border-dark text-dark bg-danger mb-3">
          <div class="card-header bg-transparent border-success"><b>Empire - 5ª Temporada Legendada Torrent (2018) 720p 1080p Download MKV</b></div>
          <div class="card-body text-dark">
            <img align="left" src="https://i2.wp.com/i.imgur.com/0anGQvs.jpg?resize=220%2C280&ssl=1" width="250px" height="310px">
            <br>
            <br>
            <p><b>Ano de Lançamento:</b> 2018</p>
            <p><b>Gênero:</b> Drama, Musical</p>
